...
@section('content')
        <div class="feturedsection">
            <h1 class="text-center"><span class="bdots">&bullet;</span><span class="carstxt">{{ trans('website.Brands') }}</span>&bullet;</h1>
        </div>
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 txt1colon ">
                                    <div class="featurecontant">
                                        <h1>{{ str_limit(getDefaultValueKey($d->title) , 20) }}</h1>
                                            <a href="{{ url(getCurrentLang().'/car?brand='.$d->id) }}" id="btnRL">READ LESS</a>
                                        </div>
                                    </div>
                                </div>
                            </div>

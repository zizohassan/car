...
@section('content')
    <div class="feturedsection">
        <h1 class="text-center"><span class="bdots">&bullet;</span><span class="carstxt">{{ trans('website.Catugoury') }}</span>&bullet;</h1>
    </div>
                        ...
                        <div class="row costumrow">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 txt1colon ">
                                <div class="featurecontant">
                                    ...
                                    <a href="{{ url(getCurrentLang().'/car?maincat='.$d->id) }}" id="btnRL">READ LESS</a>
                                </div>
                            </div>
                        </div>
                    </div>
